...
router.get('/', async (ctx, next)=> {
  ...
  //跳转微信授权扫描二维码
  await ctx.render('auth',{url:'https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid='+ plat.appid +'&pre_auth_code=' + pre_auth_code + '&redirect_uri=http://api.diandianyy.com/util/weixin/auth/callback'})
